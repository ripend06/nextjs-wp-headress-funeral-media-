            ...
            <section id="head" class="head head--style">
                <div class="head__wrap container">
                    <div class="breadcrumb ">
                      ...
                      <div class="breadcrumb__link"><i class="ph ph-caret-right breadcrumb__icon"></i>{areaName}</div>
                    </div>
                </div>
            </section>
            <section class="title">
                <div class="container">
                    <div class="head__title marginBottom--32">
                        <h1 class="h1--default">{areaName}の葬儀場</h1>
                    </div>
                </div>
            </section>
            ...
            <section id="pageNation" class="pageNation">
              <div class="pageNation__wrap container">
                <ul class="page-numbers">
                  {Array.from({ length: totalPages }, (_, index) => (
                      <li key={index + 1}>
                          <Link className={pageValue == index + 1 ? "page-numbers current" : "page-numbers"} href={`/place/${area}?page=${index + 1}`}>
                              <span style={{ margin: '0 5px' }}>{index + 1}</span>
                          </Link>
                      </li>
                  ))}
